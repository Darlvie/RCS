    ...
    if (filepath)
    {
        while (true)
        {
            ...
            if (fp)
            {
                ...
                {
                    assert(0);
                    DebugLog(@"Read HanziNumber Failed,%zu",size);
                    break;
                }
                ...
                {
                    assert(0);
                    DebugLog(@"Read pinyinSize Failed,%zu",size);
                    break;
                }
                ...
                if (size != hanZiNumber)
                {
                    DebugLog(@"Read CodeIndex Failed,%zu",size);
                    break;
                }
                size = fread(_pinyin, 1, pinyinSize, fp);
                if (size != pinyinSize)
                {
                    DebugLog(@"Read Pinyin Failed,%zu",size);
                    break;
                }
                fclose(fp);
                _inited = YES;
            ...
            {
                assert(0);
                DebugLog(@"Open Pinyin File Failed %@",filepath);
            }
            break;
        }
