...
@interface NTESBirthPickerView () <UIPickerViewDataSource,UIPickerViewDelegate>
...
- (NSInteger)daysInMonth:(NSInteger)month year:(NSInteger)year {
    NSString *formateDate = [self formateDate:year month:month day:1];
    NSDate *date = [self.formateter dateFromString:formateDate];
